...
echo ""
echo "🌐 Port Status:"
echo "  Port 3000 (dev server): $(lsof -i:3000 2>/dev/null | wc -l | tr -d ' ') connections"
...
echo "  3. Restart dev server: pnpm dev -p 3000"
echo "  4. Run fast tests: pnpm test:e2e:sanity"
