...
const FILE_THRESHOLDS: IFileThresholds = {
  // GameLogsFilters - simple component that doesn't need extensive testing (must come first)
  'src/app/components/game-logs/GameLogsFilters.tsx': {
    lines: ZERO, // No coverage needed for this simple wrapper component
    statements: ZERO, // No coverage needed for this simple wrapper component
    branches: ZERO, // No coverage needed for this simple wrapper component
    functions: ZERO, // No coverage needed for this simple wrapper component
    base: ZERO,
  },
