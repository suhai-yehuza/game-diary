-- ============================================================================
-- OPTIMIZED MIGRATION: Triggers, Constraints, and Cleanup
-- Merges migrations 002, 003 (both), 004, and 005 into one optimized file
-- ============================================================================

-- ============================================================================
-- SECTION 1: CLEANUP - Remove deprecated rating stars functionality
-- ============================================================================

-- Remove the ratingStars column if it exists
ALTER TABLE game_logs DROP COLUMN IF EXISTS "ratingStars";

-- ============================================================================
-- SECTION 2: GAME LOGS - Unique constraint and cleanup
-- ============================================================================
...
-- Add unique constraint to ensure one game log per user per game
...
-- ============================================================================
-- SECTION 3: GAME RATINGS - Auto-update triggers
-- ============================================================================
...
-- ============================================================================
-- SECTION 4: FRIENDSHIP NOTIFICATIONS - Auto-notification triggers
-- ============================================================================
...
-- ============================================================================
-- SECTION 5: FRIENDSHIP USER ARRAYS - Track pending friendships in user arrays
-- ============================================================================
...
-- 1. Cleanup of deprecated rating stars functionality
-- 2. Game log unique constraints and deduplication
-- 3. Auto-updating game ratings triggers
-- 4. Friendship notification triggers  
-- 5. User friendship array maintenance triggers
-- 6. Performance indexes for all new functionality
-- 7. Utility functions for maintenance
-- ============================================================================ 