...
export const CACHE_TTL = {
  USER: CACHE_DURATIONS.SHORT * TIME_CONSTANTS.MINUTES * TIME_CONSTANTS.MILLISECONDS_PER_SECOND, // 5 minutes
  GAME: CACHE_DURATIONS.MEDIUM * TIME_CONSTANTS.MINUTES * TIME_CONSTANTS.MILLISECONDS_PER_SECOND, // 10 minutes
  TEAM: CACHE_DURATIONS.LONG * TIME_CONSTANTS.MINUTES * TIME_CONSTANTS.MILLISECONDS_PER_SECOND, // 15 minutes
  PLAYER: CACHE_DURATIONS.LONG * TIME_CONSTANTS.MINUTES * TIME_CONSTANTS.MILLISECONDS_PER_SECOND, // 15 minutes
  USER_GAME_LOGS:
    CACHE_DURATIONS.SHORT * TIME_CONSTANTS.MINUTES * TIME_CONSTANTS.MILLISECONDS_PER_SECOND, // 5 minutes
  GAME_STATS:
    CACHE_DURATIONS.MEDIUM * TIME_CONSTANTS.MINUTES * TIME_CONSTANTS.MILLISECONDS_PER_SECOND, // 10 minutes
  TEAM_STATS:
    CACHE_DURATIONS.LONG * TIME_CONSTANTS.MINUTES * TIME_CONSTANTS.MILLISECONDS_PER_SECOND, // 15 minutes
  PLAYER_STATS:
    CACHE_DURATIONS.LONG * TIME_CONSTANTS.MINUTES * TIME_CONSTANTS.MILLISECONDS_PER_SECOND, // 15 minutes
  COMMENTS: CACHE_DURATIONS.SHORT * TIME_CONSTANTS.MINUTES * TIME_CONSTANTS.MILLISECONDS_PER_SECOND, // 5 minutes
  REACTIONS:
    CACHE_DURATIONS.SHORT * TIME_CONSTANTS.MINUTES * TIME_CONSTANTS.MILLISECONDS_PER_SECOND, // 5 minutes
  ...
  FRIENDSHIPS:
    CACHE_DURATIONS.SHORT * TIME_CONSTANTS.MINUTES * TIME_CONSTANTS.MILLISECONDS_PER_SECOND, // 5 minutes
  SEASONS:
    CACHE_DURATIONS.EXTENDED * TIME_CONSTANTS.MINUTES * TIME_CONSTANTS.MILLISECONDS_PER_SECOND, // 30 minutes
  LEAGUES:
    CACHE_DURATIONS.EXTENDED * TIME_CONSTANTS.MINUTES * TIME_CONSTANTS.MILLISECONDS_PER_SECOND, // 30 minutes
} as const;
