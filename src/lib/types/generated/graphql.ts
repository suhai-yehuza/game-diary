...
export type SendFriendRequestMutation = { __typename?: 'Mutation', sendFriendRequest: { __typename?: 'SendFriendRequestResponse', friendship?: { __typename?: 'Friendship', id: string, status: FriendshipStatus, created_at: string, updated_at: string, initiator: { __typename?: 'UserSummary', id: string, username: string, first_name: string, last_name: string, email_address?: string | null, image_url?: string | null, isAdmin: boolean }, recipient: { __typename?: 'UserSummary', id: string, username: string, first_name: string, last_name: string, email_address?: string | null, image_url?: string | null, isAdmin: boolean } } | null, errors?: Array<{ __typename?: 'ErrorResult', message: string, code?: string | null, field?: string | null }> | null } };
...
export type UserSummaryFragmentFragment = { __typename?: 'UserSummary', id: string, username: string, first_name: string, last_name: string, email_address?: string | null, image_url?: string | null, isAdmin: boolean };

export type ReactionFragmentFragment = { __typename?: 'Reaction', id: string, emoji: string, user_id: string, target_id: string, target_type: ParentType, created_at: string, updated_at: string, deleted_at?: string | null, user: { __typename?: 'UserSummary', id: string, username: string, first_name: string, last_name: string, email_address?: string | null, image_url?: string | null, isAdmin: boolean } };

export type CommentFragmentFragment = { __typename?: 'Comment', id: string, user_id: string, parent_id: string, parent_type: ParentType, content: string, depth: number, created_at: string, updated_at: string, totalChildCommentCount: number, totalReactionCount: number, user: { __typename?: 'UserSummary', id: string, username: string, first_name: string, last_name: string, email_address?: string | null, image_url?: string | null, isAdmin: boolean }, reactions: Array<{ __typename?: 'Reaction', id: string, emoji: string, user_id: string, target_id: string, target_type: ParentType, created_at: string, updated_at: string, deleted_at?: string | null, user: { __typename?: 'UserSummary', id: string, username: string, first_name: string, last_name: string, email_address?: string | null, image_url?: string | null, isAdmin: boolean } }> };
...
export type GetUsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'UserSummary', id: string, username: string, first_name: string, last_name: string, email_address?: string | null, image_url?: string | null, isAdmin: boolean }> };
...
export type GetUserQuery = { __typename?: 'Query', user?: { __typename?: 'UserSummary', id: string, username: string, first_name: string, last_name: string, email_address?: string | null, image_url?: string | null, isAdmin: boolean } | null };
...
export type NotificationFragmentFragment = { __typename?: 'Notification', id: string, user_id: string, type: string, title: string, message: string, target_id?: string | null, target_type?: string | null, resolved: boolean, read: boolean, created_at: string, updated_at: string, deleted_at?: string | null };
...
export type GetUserNotificationsQuery = { __typename?: 'Query', userNotifications: { __typename?: 'NotificationConnection', totalCount: number, edges: Array<{ __typename?: 'NotificationEdge', cursor: string, node: { __typename?: 'Notification', id: string, user_id: string, type: string, title: string, message: string, target_id?: string | null, target_type?: string | null, resolved: boolean, read: boolean, created_at: string, updated_at: string, deleted_at?: string | null } }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null } } };
...
export type MarkNotificationAsReadMutation = { __typename?: 'Mutation', markNotificationAsRead: { __typename?: 'MarkNotificationAsReadResponse', success: boolean, errors?: Array<{ __typename?: 'ErrorResult', message: string, code?: string | null, field?: string | null }> | null } };

export type MarkAllNotificationsAsReadMutationVariables = Exact<{ [key: string]: never; }>;


export type MarkAllNotificationsAsReadMutation = { __typename?: 'Mutation', markAllNotificationsAsRead: { __typename?: 'MarkAllNotificationsAsReadResponse', success: boolean, errors?: Array<{ __typename?: 'ErrorResult', message: string, code?: string | null, field?: string | null }> | null } };
