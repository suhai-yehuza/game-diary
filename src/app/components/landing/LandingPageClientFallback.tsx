        ...
        <div className="bg-surface-card/80 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-xl border border-theme-primary/50 overflow-hidden">
          <div className="bg-theme-muted p-4 sm:p-6 text-text-inverse">
            <div className="animate-pulse">
              ...
              <div className="h-4 bg-bg-theme-secondary rounded w-1/2" />
            </div>
          </div>
            ...
            <div className="space-y-3">
              {Array.from({ length: 3 }, (_, i) => (
                <div key={`skeleton-${i}`} className="animate-pulse">
                  <div className="h-4 bg-bg-theme-secondary rounded w-full mb-2" />
                  <div className="h-3 bg-bg-theme-secondary rounded w-2/3" />
                </div>
              ))}
            </div>
          </div>
    ...
    return (
      <div className="text-center py-8">
        ...
        <button
          ...
          className="px-6 py-2 bg-brand-primary text-text-inverse rounded-lg hover:bg-brand-primary-hover transition-colors"
        >
          Refresh Page
        </button>
      </div>
