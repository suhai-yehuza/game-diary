...
export const SEARCH_STYLES = {
  ...
  gradients: {
    game: 'from-brand-primary/20 to-brand-primary/5',
    player: 'from-purple-500/20 to-purple-500/5',
    team: 'from-red-500/20 to-red-500/5',
    user: 'from-green-500/20 to-green-500/5',
    gameLog: 'from-amber-500/20 to-amber-500/5',
    default: 'from-bg-theme-secondary/20 to-bg-theme-secondary/5',
  },
  ...
  avatar: {
    ...
    game: 'bg-gradient-to-br from-brand-primary to-brand-primary-hover',
    player: 'bg-gradient-to-br from-purple-500 to-purple-600',
    team: 'bg-gradient-to-br from-red-500 to-red-600',
    user: 'bg-gradient-to-br from-green-500 to-green-600',
    gameLog: 'bg-gradient-to-br from-amber-500 to-amber-600',
  },

  // Badge styles
  badge: {
    base: 'inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border',
    game: 'bg-brand-primary/10 text-brand-primary border-brand-primary/30',
