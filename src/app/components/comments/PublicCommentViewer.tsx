...
export function PublicCommentViewer({ commentId, className = '' }: IPublicCommentViewerProps) {
  ...
  if (error) {
    return (
      ...
      >
        <p className="text-semantic-error">Error loading public comment: {error.message}</p>
        <button
    ...
    <div className={`p-4 border border-theme-primary rounded-lg ${className}`}>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="p-3 bg-brand-primary/10 rounded">
          <p className="text-sm text-brand-primary font-medium">Total Public Replies</p>
          <p className="text-2xl font-bold text-brand-primary">{totalReplyCount}</p>
        </div>
        {totalReactionCount > 0 && (
          <div className="p-3 bg-semantic-success/10 rounded">
            <p className="text-sm text-semantic-success font-medium">Total Public Reactions</p>
