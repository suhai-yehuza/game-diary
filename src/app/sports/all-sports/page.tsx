...
export default function AllSportsPage() {
  return (
    ...
    >
      <div className="mb-6 p-4 bg-blue-900/20 dark:bg-blue-900/20 rounded-lg">
        <p className="all-sports-welcome-text">
          Welcome to All Sports - Explore your favorite leagues
        </p>
      </div>
    </SportsPageLayout>
  );
