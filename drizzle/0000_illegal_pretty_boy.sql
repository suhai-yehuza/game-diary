CREATE TABLE "comments" (
	"id" varchar(255) PRIMARY KEY DEFAULT '0197220b-0088-71ef-b10b-bd6c9c10ad97-mbb0vzbc-bbemw8tch7e-lwv' NOT NULL,
	"userId" varchar(255),
...
CREATE TABLE "friendships" (
	"id" varchar(255) PRIMARY KEY DEFAULT '0197220b-0088-71ef-b10b-bb09f613934d-mbb0vzbc-x5nsl8sofz-lwv' NOT NULL,
...
CREATE TABLE "game_logs" (
	"id" varchar(255) PRIMARY KEY DEFAULT '0197220b-0088-71ef-b10b-ca7811ccd89f-mbb0vzbc-4jl19tubvey-lwv' NOT NULL,
	"userId" varchar(255),
	...
	"ratingStars" varchar(10) DEFAULT '',
...
CREATE TABLE "game_ratings" (
	"id" varchar(255) PRIMARY KEY DEFAULT '0197220b-0088-71ef-b10b-cfc551f8dd6f-mbb0vzbd-sz5k37f92h-lwv' NOT NULL,
	"gameId" varchar(255) NOT NULL,
...
CREATE TABLE "game_stats" (
	"id" varchar(255) PRIMARY KEY DEFAULT '0197220b-0086-72b9-99a5-98da5d1a955d-mbb0vzba-cu4e80mv4qu-lwv' NOT NULL,
	"gameId" varchar(255) NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "games" (
	"id" varchar(255) PRIMARY KEY DEFAULT '0197220b-0088-71ef-b10b-c5d7bd42b41d-mbb0vzbc-ja6u27w74dn-lwv' NOT NULL,
...
CREATE TABLE "nba_games" (
	"id" text PRIMARY KEY DEFAULT '0197220b-0085-74da-94e4-41524d1bfab9-mbb0vzb9-tywjdmtn0s-lwv' NOT NULL,
...
CREATE TABLE "reactions" (
	"id" varchar(255) PRIMARY KEY DEFAULT '0197220b-0088-71ef-b10b-c2b874ba9778-mbb0vzbc-dkgws5846fn-lwv' NOT NULL,
	"userId" varchar(255),
...
CREATE TABLE "team_h2h" (
	"id" varchar(255) PRIMARY KEY DEFAULT '0197220b-0085-74da-94e4-44d3ce85d29b-mbb0vzb9-6k4t1nw7koq-lwv' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "users" (
	"id" varchar(255) PRIMARY KEY DEFAULT '0197220b-0088-71ef-b10b-b6aff9052671-mbb0vzbc-cfxm6yc251j-lwv' NOT NULL,
