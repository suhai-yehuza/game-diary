CREATE TABLE "comments" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01972861-f58e-7485-a2b0-577f743892fd-mbcs7oum-mibaeh90hj-123c' NOT NULL,
	"userId" varchar(255),
...
CREATE TABLE "game_logs" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01972861-f58e-7485-a2b0-61be761390a7-mbcs7oum-i6v7ds57wh-123c' NOT NULL,
	"userId" varchar(255),
	...
	"ratingStars" varchar(10) DEFAULT '' NOT NULL,
	"notes" text DEFAULT '',
	"tags" text[] DEFAULT '{}',
...
CREATE TABLE "game_ratings" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01972861-f58f-71cb-ab7c-f1a53d3dea3e-mbcs7oun-a9cc7vfl3mh-123c' NOT NULL,
	"gameId" varchar(255) NOT NULL,
...
CREATE TABLE "game_stats" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01972861-f58c-7055-9ee9-7dbf834225b9-mbcs7ouk-46r43c5k59x-123c' NOT NULL,
	"gameId" varchar(255) NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "games" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01972861-f58e-7485-a2b0-5c5ae0bd403b-mbcs7oum-h9ef1g3uc98-123c' NOT NULL,
...
CREATE TABLE "nba_games" (
	"id" text PRIMARY KEY DEFAULT '01972861-f58b-759e-ab15-249b3667ddaf-mbcs7ouj-vwv2grwvuyl-123c' NOT NULL,
...
CREATE TABLE "reactions" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01972861-f58e-7485-a2b0-59b2caf5c8cb-mbcs7oum-98zw0bmlvpd-123c' NOT NULL,
	"userId" varchar(255),
...
CREATE TABLE "team_h2h" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01972861-f58b-759e-ab15-284f03050381-mbcs7ouj-c66qupgpjum-123c' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "users" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01972861-f58e-7485-a2b0-4d980f29f861-mbcs7oum-pb6x3ycdof-123c' NOT NULL,
