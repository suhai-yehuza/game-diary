CREATE TABLE "comments" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01974330-b7cc-77cf-aec4-ace56bb843a0' NOT NULL,
	"userId" varchar(255),
...
CREATE TABLE "friendships" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01974330-b7cc-77cf-aec4-a8dfe833422a' NOT NULL,
...
CREATE TABLE "game_logs" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01974330-b7cc-77cf-aec4-b8a754d2aa5b' NOT NULL,
	"userId" varchar(255),
...
CREATE TABLE "game_ratings" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01974330-b7cc-77cf-aec4-bfdd943a7274' NOT NULL,
	"gameId" varchar(255) NOT NULL,
...
CREATE TABLE "game_stats" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01974330-b7ca-7140-9074-9e0eb7023870' NOT NULL,
	"gameId" varchar(255) NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "games" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01974330-b7cc-77cf-aec4-b52f222910a0' NOT NULL,
...
CREATE TABLE "nba_games" (
	"id" text PRIMARY KEY DEFAULT '01974330-b7c9-7602-ae9a-3445fad0fb36' NOT NULL,
...
CREATE TABLE "reactions" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01974330-b7cc-77cf-aec4-b282c23eff37' NOT NULL,
	"userId" varchar(255),
...
CREATE TABLE "team_h2h" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01974330-b7ca-7140-9074-9b342e1388a4' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "users" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01974330-b7cc-77cf-aec4-a62f4ddd8fa4' NOT NULL,
