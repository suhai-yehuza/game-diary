...
ALTER TABLE "game_logs" ADD CONSTRAINT "game_logs_game_id_nba_games_id_fk" FOREIGN KEY ("game_id") REFERENCES "public"."nba_games"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "game_ratings" ADD CONSTRAINT "game_ratings_game_id_nba_games_id_fk" FOREIGN KEY ("game_id") REFERENCES "public"."nba_games"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_game_logs_user_created" ON "game_logs" USING btree ("user_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_game_logs_classification_created" ON "game_logs" USING btree ("classification","created_at");--> statement-breakpoint
CREATE INDEX "idx_game_logs_user_classification_created" ON "game_logs" USING btree ("user_id","classification","created_at");--> statement-breakpoint
CREATE INDEX "idx_game_logs_game_id" ON "game_logs" USING btree ("game_id");--> statement-breakpoint
CREATE INDEX "idx_game_logs_deleted_at" ON "game_logs" USING btree ("deleted_at");