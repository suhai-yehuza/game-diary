...
CREATE TABLE "team_h2h" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01970ac0-7258-7689-90c9-74e3b94664a0-mb4k8leg-6e6p7l73jt6-23fu' NOT NULL,
...
CREATE TABLE "friendships" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01970ac0-7251-728c-9b4b-3704d91aae0e-mb4k8le9-c8x43h2i0n-23fu' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "users" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01970ac0-7250-70d0-920f-942a9bee90cf-mb4k8le8-t27aw697m7q-23fu' NOT NULL,
	...
	"external_accounts" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"deleted_at" timestamp(6) with time zone,
	CONSTRAINT "users_email_address_unique" UNIQUE("email_address")
);
--> statement-breakpoint
CREATE TABLE "game_logs" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01970ac0-7258-7689-90c9-70d95b13aa17-mb4k8leg-efgjtmxz37d-23fu' NOT NULL,
	"user_id" varchar(255),
	...
	"notes" text DEFAULT '',
	"tags" text[] DEFAULT '{""}',
	"classification" varchar(255) DEFAULT 'PROTECTED' NOT NULL,
	"created_at" timestamp(6) with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp(6) with time zone DEFAULT now() NOT NULL,
	"deleted_at" timestamp(6) with time zone,
	CONSTRAINT "game_logs_classification_check" CHECK ((classification)::text = ANY ((ARRAY['PRIVATE'::character varying, 'PROTECTED'::character varying, 'PUBLIC'::character varying])::text[]))
);
--> statement-breakpoint
CREATE TABLE "game_ratings" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01970ac0-7258-7689-90c9-6fc2e356c8df-mb4k8leg-zvn0g9iqn8-23fu' NOT NULL,
	"game_id" text NOT NULL,
...
CREATE TABLE "game_stats" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01970ac0-7258-7689-90c9-66e8885bdf82-mb4k8leg-u2rxpk5mdyo-23fu' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "games" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01970ac0-7258-7689-90c9-68c90400d1df-mb4k8leg-1mos21kerwn-23fu' NOT NULL,
...
CREATE TABLE "nba_games" (
	"id" varchar(255) PRIMARY KEY DEFAULT '01970ac0-7256-76ff-bdac-8292c1a6185a-mb4k8lee-qfzodb33h1a-23fu' NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
ALTER TABLE "team_h2h" ADD CONSTRAINT "team_h2h_team2_id_teams_id_fk" FOREIGN KEY ("team2_id") REFERENCES "public"."teams"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_nba_players_seasons" ON "nba_players" USING btree ("seasons_active" jsonb_ops);--> statement-breakpoint
CREATE INDEX "idx_game_logs_user_id" ON "game_logs" USING btree ("user_id" text_ops);--> statement-breakpoint
CREATE INDEX "idx_nba_games_season" ON "nba_games" USING btree ("season_id" int4_ops);--> statement-breakpoint
CREATE INDEX "idx_reactions_target_id" ON "reactions" USING btree ("target_id" text_ops);
*/