...
- `test:e2e:fast` (duplicate of `test:e2e:smoke`)
...
=====E2E Testing=====
test:e2e:fast, test:e2e:smoke, test:e2e:critical, test:e2e:full, test:e2e:smoke:deployed, test:e2e:mock-verification, test:e2e:pre-deploy, test:e2e:post-deploy, test:e2e:load, test:e2e:responsive, test:e2e:performance, test:e2e:show-report, test:e2e:install-browsers, test:e2e:debug:ui
...
=====Debug & Maintenance=====
test:generate-results, test:generate-results:fast, test:generate-results:popular, test:generate-results:responsive, test:failing, test:failing:fast, test:failing:popular, test:failing:responsive
```
